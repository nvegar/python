...
# load images
bg = pygame.image.load(os.path.join('images','bg4.jpg'))
debris = pygame.image.load(os.path.join('images','debris2_brown.png'))
ship = pygame.image.load(os.path.join('images','ship3.png' ))
ship_thrusted = pygame.image.load(os.path.join('images','ship_thrusted3.png' ))
...
def rot_center(image, angle):
    """rotate a Surface, mantaining position."""
...
def draw(canvas):
    ...
    if game_over:
        ...
        canvas.blit(label2, (WIDTH/2 -250,HEIGHT/2 - 40))
